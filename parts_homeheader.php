...
<div class="menu_index1">
	<img src="http://digitalian.blam.co.jp/wp/wp-content/uploads/2017/11/recommend.png" alt="写真">
	<p class="menu_index_text1">
			<span style="font-size:40%;">　</span>
			<span style="font-size:120%;font-weight:bold">オススメ記事</span>　Recommend<span style="letter-spacing:3px"> </span>post
	</p>
</div>
